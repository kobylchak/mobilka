...
<body>
<div class="container">
    <form role="form" content="application/x-www-form-urlencoded" accept-charset="UTF-8"
        ...
        <input class="form-control form-group" type="text" name="delAddress" required
               placeholder="Enter delivert address">
