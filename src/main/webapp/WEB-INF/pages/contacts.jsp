...
<div class="container">
    ...
    <div align="center">
        <ul>
            <li>№ Telephone - <strong>+380985014393</strong></li>
            <li>Linkedin - <strong>linkedin.com/in/kobylchak</strong></li>
            <li>E-mail - <strong>v.kobylchak@ukr.net</strong></li>
            <li>skype - <strong>unrealsuerte</strong></li>
            <li>Viber, telegram<strong>+380985014393</strong></li>
            <li><strong>Lviv</strong></li>
