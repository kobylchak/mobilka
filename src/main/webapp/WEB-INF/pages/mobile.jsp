...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a href="/admin/orders/notfulfilled" class="nav-link">ORDERS</a>
                </li>
    ...
    <nav row class="navbar navbar-expand-lg navbar-light bg-light justify-content-around sticky-top">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-2 btn-group" role="group" aria-label="Basic example">
