...
<div class="container">
    <div id="top">
        <div class="row justify-content-around">
            <div class="col-xs-11 align-self-end">
            ...
            <div class="col-xs-1 align-self-end">
                ...
                <p class="h5"><a href="${logoutUrl}"><i class="fas fa-sign-out-alt"></i></a></p>
            </div>
        </div>
    </div>
    ...
    <div align="center">
        ...
        <form action="${regUrl}" method="POST">
            Name:<br/><input type="text" name="first" required><br/>
            Surname:<br/><input type="text" name="last" required><br/>
